...
model_name = "/checkpoint/llama_2_7b_hf"
...
model.save_pretrained("/checkpoint/llm_tolkien_llama_2_7B_local")

config = PeftConfig.from_pretrained("/checkpoint/llm_tolkien_llama_2_7B_local")
...
# Load the Lora model
trained_model = PeftModel.from_pretrained(trained_model, "/checkpoint/llm_tolkien_llama_2_7B_local")
