...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", default="train", choices=["train", "reconstruction", "train_avd"]
    )
    parser.add_argument("--log_dir", default="log", help="path to log into")
    parser.add_argument(
        "--checkpoint", default=None, help="path to checkpoint to restore"
    )
    parser.add_argument(
        "--device_ids",
        default="0,1",
    ...
    dataset = FramesDataset(
        is_train=(opt.mode.startswith("train")), **config["dataset_params"]
    )
